...
public class GulimallSearchApplicationTests {
    ...
    public void getIndex() throws IOException {
        GetRequest reqeust = new GetRequest("user", "1");
        GetResponse documentFields = restHighLevelClient.get(reqeust, RequestOptions.DEFAULT);
        System.out.println(documentFields.getSourceAsString());
    }

    /**
     * 复杂检索:在bank中搜索address中包含mill的所有人的年龄平均分布以及平均年龄,平均薪资
     */
    @Test
